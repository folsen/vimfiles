...
syntax match haddockHeading
  \ "\*\+.*\%(-}\)\@=\|\*\+.*$"
  \ contained containedin=hsLineComment
...
syntax region haddockExample matchgroup=haddockREPL
  \ start="\%(<\S\+\)\@<!>\%(>>\)\?" end="$"
  \ contained contains=TOP containedin=hsLineComment
...
if version >= 508 || !exists("did_hs_syntax_inits")
  ...
  HiLink haddockHeading Title
  HiLink haddockChunk Title
  HiLink haddockAnnotation Title
  HiLink haddockIdentifier Underlined
  HiLink haddockModule Underlined
  HiLink haddockEmphasis Todo
  HiLink haddockURL Underlined
  HiLink haddockREPL Delimiter
  HiLink haddockLabel Label
  HiLink haddockAnchor Underlined 
